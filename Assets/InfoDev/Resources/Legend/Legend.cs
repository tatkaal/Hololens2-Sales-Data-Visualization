...
*//*    private Interactions interactionsObject = null;*//*
    ...
    public void UpdateSpecs(JSONNode legendSpecs, ref InfoDev.ChannelEncoding channelEncoding, GameObject markPrefab)
    {
        // Create title:
    ...
    private void ConstructGradient(JSONNode legendSpecs, ref ChannelEncoding channelEncoding)
    {
        ...
        {
            width = legendSpecs["gradientWidth"].AsFloat * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
            height = legendSpecs["gradientHeight"].AsFloat * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
        }
    ...
    internal void SetOrientation(string orient, string face, float x, float y, float z)
    {
        ...
        gameObject.transform.localPosition = new Vector3(x, y, z) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
    }
*//*
