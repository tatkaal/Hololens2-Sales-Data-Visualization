...
/*        internal void Init(Interactions interactions, string field)
        ...
        public void UpdateSpecs(JSONNode axisSpecs, InfoDev.Scale scale)
        {
        ...
        private void EnableThresholdFilter(JSONNode axisSpecs, InfoDev.Scale scale)
        {
         ...
         /*   InfoDev.SliderGestureControlBothSide sliderControl =
                    slider.GetComponent<InfoDev.SliderGestureControlBothSide>();
        ...
        {
            titleOffset = titleOffset + (float.Parse(titlePadding) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR);
        }
        ...
        {
            length = length * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
        ...
        public void ConstructTicks(JSONNode axisSpecs, InfoDev.Scale scale)
        {
            ...
            for (int i = 0; i < axisSpecs["values"].Count; i++)
            {
                ...
                float pos = float.Parse(scale.ApplyScale(domainValue)) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
