...
namespace InfoDev
{
    ...
    {
        public string markName = InfoDev.Vis.UNDEFINED;
        ...
        */
        ...
        public void InitTooltip(ref GameObject tooltipObject)
        {
            ...
            if (renderer != null)
            {
                InfoDev.GazeResponder sc = gameObject.AddComponent(typeof(InfoDev.GazeResponder)) as InfoDev.GazeResponder;
        ...
        private void SetLocalPos(string value, int dim)
        {
            ...
            float pos = float.Parse(value) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
        ...
        {
            float size = float.Parse(value) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
        ...
        {
            float offset = float.Parse(value) * InfoDev.Vis.SIZE_UNIT_SCALE_FACTOR;
