...
namespace InfoDev
{
    public class Parser
    {
        static string specsBaseDir = "/InfoDevSpecs/";
        static string dataBaseDir = "/InfoDevData/";
        ...
        private void CreateEmptyTemplateSpecs(string specsFilename, ref JSONNode visSpecs)
        {
            ...
            dataSpecs.Add("url", new JSONString(InfoDev.Vis.UNDEFINED));
            emptySpecs.Add("data", dataSpecs);
            emptySpecs.Add("mark", new JSONString(InfoDev.Vis.UNDEFINED));
        ...
        {
            if (visSpecs["data"].Value == InfoDev.Vis.UNDEFINED || visSpecs["data"]["url"].Value == InfoDev.Vis.UNDEFINED) return;
