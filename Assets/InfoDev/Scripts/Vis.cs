...
namespace InfoDev
{
    ...
    public class Vis : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            viewParentObject = gameObject.transform.Find("InfoDevView").gameObject;
			marksParentObject = viewParentObject.transform.Find("InfoDevMarks").gameObject;
			guidesParentObject = viewParentObject.transform.Find("InfoDevGuides").gameObject;
			interactionsParentObject = gameObject.transform.Find("InfoDevInteractions").gameObject;

            if (viewParentObject == null || marksParentObject == null)
            {
                throw new Exception("Unable to load InfoDevView and/or InfoDevMarks objects.");
            }
...
//                    throw new System.Exception("Make sure interaction object has type, field, and domain specs.");
            ...
            ref List<GameObject> markInstances)
        {
            for(int i = 0; i < markInstances.Count; i++)
            {
                ...
                if (channelEncoding.value != InfoDev.Vis.UNDEFINED)
                {
        ...
        private GameObject LoadMarkPrefab(string markName)
        {
            ...
            {
                InfoDev.Mark markComponent = markPrefabResult.AddComponent(typeof(InfoDev.Mark)) as InfoDev.Mark;
            }
        ...
        private void UpdateVisData()
        {
            ...
            //            SubsampleData(valuesSpecs, 8, "Assets/InfoDev/Resources/cars_subsampled.json");
        }
        ...
        {
			Transform guiTransform = parentObject.transform.Find("InfoDevGUI");
        ...
        {
            string[] dirs = Directory.GetFiles(Application.dataPath + "/StreamingAssets/InfoDevData");
            dataList = new List<string>();
            dataList.Add(InfoDev.Vis.UNDEFINED);
            dataList.Add("inline");
        ...
        private void InitMarksList()
        {
            ...
            marksList.Add(InfoDev.Vis.UNDEFINED);
            ...
            {
                throw new System.Exception("Cannot find marks.json file in Assets/InfoDev/Resources/Marks/ directory");
            }

#if UNITY_EDITOR
            string[] dirs = Directory.GetFiles("Assets/InfoDev/Resources/Marks");
            for (int i = 0; i < dirs.Length; i++)
            {
